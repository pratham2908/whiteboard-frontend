...
const whiteBoard = document.body;
...
function drawShape(e, shape) {
    ...
    if (shape.id == "triangle") {
        ...
        // shapeDemo.classList.add("triangle");
        // shapeDemo.classList.remove("rectangle");
        // shapeDemo.style.left = triangle[0].x + "px";
        // shapeDemo.style.top = triangle[1].y + toolbar.offsetHeight + "px";
        // shapeDemo.style.width = triangle[2].x - triangle[0].x + "px";
        // shapeDemo.style.height = triangle[2].y - triangle[1].y + "px";
    ...
    if (shape.id == "rectangle") {
        ...
        shapeDemo.classList.add("rectangle");
        shapeDemo.classList.remove("triangle");
    ...
    if (shape.id == "circle") {
        ...
        shapeDemo.classList.remove("rectangle", "triangle");
